...
//
// Proxies client-submitted quote/intake form payloads to the Discord webhook
...
//   429 Too Many Requests  — basic IP-based rate limit (in-memory, per cold start)
//   500 Server Error       — missing env var
//   502 Bad Gateway        — Discord returned non-2xx; upstream failure
//
// Security hardening:
//   - CORS locked to known site domains; same-origin requests (no Origin header) allowed
//   - Body size limit 32 KB
//   - Per-IP rate limit: 5 requests per 60 seconds (in-memory)
