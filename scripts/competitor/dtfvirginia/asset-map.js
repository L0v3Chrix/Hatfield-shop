...
export const IMAGE_FAMILIES = {
  ...
  // Photoreal generated set (D4/D5, curated 2026-06-11) — replaces the former
  // product-graphics illustrations; legacy .webp illustrations stay on disk.
  apparelSamplesStack: family('gen-apparel-samples-stack', 'Stack of folded blank tees ready for custom printing'),
  appalachianRidgeFilm: family('gen-appalachian-ridge-film', 'Appalachian mountain ridge design printed on transfer film'),
  blankShirtTransfer: family('gen-blank-shirt-transfer', 'Blank tee with a transfer positioned before pressing'),
  builderCanvasLayout: family('gen-builder-canvas-layout', 'Gang sheet with abstract designs arranged edge to edge'),
  dtfTransferPeel: family('gen-dtf-transfer-peel', 'Peeling DTF film off a freshly pressed shirt to reveal the print'),
  gangSheetRoll: family('gen-gang-sheet-roll', 'Printed gang sheet roll packed with colorful artwork'),
  glitterFilmSheet: family('gen-glitter-film-sheet', 'Glitter transfer sheet close up with sparkling flake'),
  glowFilmSheet: family('gen-glow-film-sheet', 'Glow in the dark transfer sheet shown glowing and in daylight'),
  heatPressShirt: family('gen-heat-press-shirt', 'Heat press pressing a custom shirt with steam rising'),
  pressedShirtFront: family('gen-pressed-shirt-front', 'Finished shirt with a vivid freshly pressed design'),
  printerOutputFilm: family('gen-printer-output-film', 'Wide format printer outputting printed DTF film'),
  serviceSampleBundle: family('gen-service-sample-bundle', 'Fanned printed sample swatches on a dark workbench'),
  shippingPouchTransfers: family('gen-shipping-pouch-transfers', 'Rolled printed transfers boxed and ready to ship'),
  sublimationTumbler: family('gen-sublimation-tumbler', 'Tumbler with a vibrant full wrap sublimation print'),
  uvStickerPack: family('gen-uv-dtf-sticker-pack', 'UV DTF sticker sheet with decals applied to a dark tumbler'),
  wideFormatRoll: family('gen-wide-format-roll', 'Wide format print roll with a bold colorful graphic'),
  // D4 gap subjects
  genMagnetTruckDoor: family('gen-magnet-truck-door', 'Printed magnetic sign mounted on a work truck door'),
  genPerfWindowVinyl: family('gen-perf-window-vinyl', 'Perforated window vinyl graphic on a storefront window'),
  genHockeyPuck: family('gen-hockey-puck', 'Hockey puck with a full color printed top face'),
  genCoinDisplay: family('gen-coin-display', 'Tray of custom printed commemorative coins'),
}
...
export const HANDLE_IMAGE_OVERRIDES = {
  'dtfva-42-custom-sublimation-gang-sheets-builder': { src: `${SHOPIFY_ASSET_BASE}/42-gang-sheet-builder-card.webp`, alt: '42 inch gang sheet builder sample' },
  'dtfva-custom-dtf-gang-sheets-dtf-virginia': { src: `${SHOPIFY_ASSET_BASE}/46-gang-sheet-card.webp`, alt: '46 inch gang sheet sample' },
  'dtfva-america-s-250th-anniversary-patch-1-inch-circle': { src: `${SHOPIFY_ASSET_BASE}/250th-anniversary-card.webp`, alt: 'America\'s 250th anniversary patch sample' },
  'dtfva-brand-growth-pack': { src: `${SHOPIFY_ASSET_BASE}/guru-pack-card.webp`, alt: 'GURU branding kit growth pack sample' },
  'dtfva-brand-business-pack': { src: `${SHOPIFY_ASSET_BASE}/items-stickerd-card.webp`, alt: 'Merch branding kit business pack sample' },
  'dtfva-custom-sublimation-transfers-by-size': { src: `${SHOPIFY_ASSET_BASE}/custom-sublimation-transfers-by-size-card.webp`, alt: 'Custom sublimation transfers by size sample' },
  'dtfva-custom-glitter-dtf-transfer-by-size': { src: `${SHOPIFY_ASSET_BASE}/custom-glitter-dtf-transfer-by-size-card.webp`, alt: 'Custom glitter DTF transfer by size sample' },
  'dtfva-custom-fluorescent-dtf-transfers-by-size': { src: `${SHOPIFY_ASSET_BASE}/custom-flouresent-dtf-transfers-by-size-card.webp`, alt: 'Custom fluorescent DTF transfers by size sample' },
  'dtfva-custom-dtf-gang-sheets-printing-service': { src: `${SHOPIFY_ASSET_BASE}/custome-22-gang-sheet-builder-card.webp`, alt: 'Custom 22 inch gang sheet builder sample' },
  'dtfva-glitter-dtf-transfers-builder': { src: `${SHOPIFY_ASSET_BASE}/22-glitter-dtf-transfer-builder-card.webp`, alt: '22 inch glitter DTF transfer builder sample' },
  'dtfva-next-level-3600': { src: `${SHOPIFY_ASSET_BASE}/next-level-3600-cotton-crew-t-shirt-card.webp`, alt: 'Next Level 3600 cotton crew t-shirt sample' },
  'dtfva-bella-canvas-3001': { src: `${SHOPIFY_ASSET_BASE}/bella-canvas-3001-unisex-jersey-tee-card.webp`, alt: 'BELLA + CANVAS 3001 unisex jersey tee sample' },
  'dtfva-custom-shaka-wear-drop-shoulder-cropped-t-shirt-premium-blank': { src: `${SHOPIFY_ASSET_BASE}/custom-shaka-wear-drop-shoulder-cropped-t-shirt-premium-blank-card.webp`, alt: 'Custom Shaka Wear drop shoulder cropped t-shirt sample' },
  'dtfva-custom-shaka-wear-max-heavyweight-short-sleeve-t-shirt-premium-blank': { src: `${SHOPIFY_ASSET_BASE}/custom-shaka-wear-max-heavyweight-short-sleeve-t-shirt-premium-blank-card.webp`, alt: 'Custom Shaka Wear Max heavyweight short sleeve t-shirt sample' },
  'dtfva-custom-american-apparel-unisex-heavyweight-cotton-long-sleeve-t-shirt': { src: `${SHOPIFY_ASSET_BASE}/custom-american-apparel-unisex-heavyweight-cotton-long-sleeve-t-shirt-card.webp`, alt: 'Custom American Apparel heavyweight cotton long sleeve t-shirt sample' },
  'dtfva-custom-los-angeles-apparel-1865gd-garment-dye-sleeveless-tee': { src: `${SHOPIFY_ASSET_BASE}/custom-los-angeles-apparel-1865gd-garment-dye-sleeveless-tee-card.webp`, alt: 'Custom Los Angeles Apparel 1865GD garment dye sleeveless tee sample' },
  'dtfva-custom-dtf-gang-sheets-30-inches': { src: `${SHOPIFY_ASSET_BASE}/dtf-gang-sheets-30-card.webp`, alt: 'DTF gang sheets 30 inch sample' },
  'dtfva-window-clings': { src: `${SHOPIFY_ASSET_BASE}/window-front-card.webp`, alt: 'Window cling storefront sample' },
  'dtfva-perforated-window-vinyl': { src: `${SHOPIFY_ASSET_BASE}/perforated-window-vinyl-window-perf-graphics-card.webp`, alt: 'Perforated window vinyl sample' },
  'dtfva-3d-puff-transfers': { src: `${SHOPIFY_ASSET_BASE}/puff-shirt2-card.webp`, alt: '3D puff transfer shirt sample' },
  'dtfva-custom-dtf-transfers-by-size-virginia': { src: `${SHOPIFY_ASSET_BASE}/custom-dtf-transfers-by-size-card.webp`, alt: 'Custom DTF transfers by size sample' },
  'dtfva-sublimation-gang-sheets-bulk-printing': { src: `${SHOPIFY_ASSET_BASE}/42-and-22-sublimation-gangsheet-card.webp`, alt: '42 and 22 inch sublimation gang sheet sample' },
  'dtfva-custom-sublimation-gang-sheets': { src: `${SHOPIFY_ASSET_BASE}/42-and-22-sublimation-gangsheet-card.webp`, alt: '42 and 22 inch sublimation gang sheet sample' },
  'dtfva-fluorescent-dtf-printing-bold-bright-stunning': { src: `${SHOPIFY_ASSET_BASE}/fluorescent-dtf-printing-bold-bright-stunning-card.webp`, alt: 'Fluorescent DTF printing bold bright and stunning sample' },
  'dtfva-digital-factory-dtf-desktop-edition': { src: `${SHOPIFY_ASSET_BASE}/digital-factory-12-card.webp`, alt: 'Digital Factory 12 Direct to Film Edition icon' },
  'dtfva-add-driver-port-24-wide-or-larger': { src: `${SHOPIFY_ASSET_BASE}/add-driver-port-24-wide-or-larger-card.webp`, alt: 'Add driver port 24 inch wide or larger sample' },
}
...
const PRODUCT_RULES = [
  ...
  [/hockey|puck/, IMAGE_FAMILIES.genHockeyPuck, 'Sports products'],
  // "jersey" deliberately excluded — it is a fabric word in apparel titles
  [/sports/, IMAGE_FAMILIES.hMJersey, 'Sports products'],
  ...
  [/coin/, IMAGE_FAMILIES.genCoinDisplay, 'Promotional products'],
  [/personalized|promo/, IMAGE_FAMILIES.featuredMerchScene, 'Promotional products'],
  [/perf/, IMAGE_FAMILIES.genPerfWindowVinyl, 'Signage and magnets'],
  [/magnet/, IMAGE_FAMILIES.genMagnetTruckDoor, 'Signage and magnets'],
  ...
  [/vinyl|graphics|sign/, IMAGE_FAMILIES.wideFormatRoll, 'Signage and magnets'],
...
const COLLECTION_RULES = [
  ...
  [/magnet/, IMAGE_FAMILIES.genMagnetTruckDoor],
  [/window|cling/, IMAGE_FAMILIES.windowVinylDecal],
  [/banner|poster/, IMAGE_FAMILIES.partyBanner],
  [/coin/, IMAGE_FAMILIES.genCoinDisplay],
  [/floor|vinyl|graphics/, IMAGE_FAMILIES.wideFormatRoll],
  ...
  [/foil|spangle|gold|silver/, IMAGE_FAMILIES.glitterFilmSheet],
  [/glitter|specialty/, IMAGE_FAMILIES.glitterFootballTee],
